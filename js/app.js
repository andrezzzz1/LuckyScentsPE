...
function agregarAlCarrito(e) {
  ...
  if (btn) {
    ...
    const producto = {
    id: btn.dataset.id, // ID correcto desde el botón
    nombre: card.querySelector(".card-title").textContent,
    categoria: card.querySelector(".card-body p strong")?.textContent || "Perfume",
    precio: parseFloat(
      ...
      <div class="container mb-3">
        <div class="row align-items-center border-bottom py-2">
          ...
          <div class="col-3 text-end">
            ...
            <span class="fs-5 precio">S/${(producto.precio * producto.cantidad).toFixed(2)}</span>
            </span>
